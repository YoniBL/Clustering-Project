...
/* Main SymNMF function
gets data, initial H, n, d, k, @ret = final H */
...
gets data, n, d, k, @ret = Similarity Matrix */
...
gets data, n, d, k, @ret = Diagonal Degree Matrix */
